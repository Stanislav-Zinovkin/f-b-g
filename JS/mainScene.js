export default class MainScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('fisher', 'assets/fisherman/GraveRobber_hook.png', {
            frameWidth: 48,
            frameHeight: 48
        });
    }
    ...
    createEnvironment() {
        this.add.text(250, 280, 'Click to fish', { fontSize: '20px', fill: 'grey' });
        ...
        if (this.caughtFish) {
            ...
            this.tweens.add({
                ...
                onComplete: () => {
                    ...
                    const wishes = ['Ти крутий рибалка', 'Du bist meine schatze!', 'З Днем народження, кохана!'];
                    const message = Phaser.Utils.Array.GetRandom(wishes);
    
                    this.add.text(250, 300, message, {
                        fontSize: '24px',
                        fill: '#ffffff',
                        stroke: '#000',
                        strokeThickness: 3,
                    ...
                    if (this.fishCaughtCount >= this.fishes.length) {
                        this.add.text(200, 200, 'Усі риби спіймані! 🎉', {
                            fontSize: '28px',
                            fill: '#00ff00',
                            stroke: '#000',
                            strokeThickness: 4,
